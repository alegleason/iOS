...
var donuts: [String] = ["Big", "Yellow", "Nice", "Sixty", "Ari", "DG"]
var donuts_price: [Int] = [2, 4, 1, 5, 2, 5]

donuts.removeLast()
donuts_price.removeLast()

donuts.insert("Newby", at: 0)
donuts_price.insert(0, at: 0)

donuts.removeAll()
donuts_price.removeAll()
