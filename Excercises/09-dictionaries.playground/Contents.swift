...
/*
 ...
 2.  Add 5 animals to this dictionary
 ...
 5. Store 5 state names and abbreviations in this dictionary and then print them in this format: `Y: X` where Y is the name of the state and where X is the abbreviation
...
var animals: [String:String] = [String:String]()
animals["Snake"] = "Large sticky animal"
animals["Rat"] = "The enemy of snakes"
animals["Dog"] = "The bff of the human"
animals["Humans"] = "Humans are mamals too"
animals["Eagle"] = "Appears on Mexico's flag"

for (key, value) in animals {
    print("Animal: \(key) -- Description: \(value)")
}
